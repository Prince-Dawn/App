...
export function Btn3() {
  return (
    ...
    <div className=" flex justify-center items-center my-[30px]">
      <input type="email" name="" id="" placeholder="Your Email..." className="w-[500px] h-[50px] text-xl translate-x-[65px] rounded-[25px] pl-[15px] font-normal placeholder:text-stone-700 text-stone-700 pr-[110px]"/>
